    ...
    <main>
        ...
        <div class="contenedor__todo">
            ...
            <div class="contenedor__login-register">
                ...
                <form action="../BackEnd/loginFuncionario_be.php" method="POST"  class="formulario__login">
                ...
                <form action="../BackEnd/registerFuncionario_be.php" method="POST" class="formulario__register">
                    <h2>Regístrarse</h2>
