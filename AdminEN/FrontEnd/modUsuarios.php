...
<body>
   <div class="container">
    ...
    <div class="cliente">
        <div id="usuario">
   <p id="Usuario">Client</p>
   <a href="modUserAdmin.php"><button id="boton1" type="button">Modify</button></a>
</div>
</div>

<div class="camionero">
<div id="usuario">
<p id="Usuario">Truckers</p>
<a href="modCamioneroAdmin.php"><button id="boton1" type="button">Modify</button></a>
</div>
</div>

<div class="funcionario">
        <div id="usuario">
   <p id="Usuario">officer</p>
   <a href="modFunAdmin.php"><button id="boton1" type="button">Modify</button></a>
    </div>
</div>

<div class="administrador">
<div id="usuario">
    <p id="Usuario">Admin</p>
    <a href="modAdminAdmin.php"><button id="boton1" type="button">Modify</button></a>
</div>
</div>
</div>
