...
<head>
    ...
    <link rel="stylesheet" href="../../Camionero/CSS/estiloCamioneroPagina.css">
...
<body>
   ...
   <div class="camioneta">
       <div id="usuario">
  <p id="Usuario">Van</p>
  <a href="adminCamioneta.php"><button id="boton1" type="button">Enter</button></a>
   </div>
</div>

<div class="camion">
<div id="usuario">
   <p id="Usuario">Truck</p>
   <a href="adminCamion.php"><button id="boton1" type="button">Enter</button></a>
</div>
</div>
</div>
