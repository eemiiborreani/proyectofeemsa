...
<body>
   <div class="container">
    ...
    <a id="paq" class="fa fa-plus-square"></a>
                <div id="adm">
                <form action="../BackEnd/registerCamion_be.php" method="POST" class="formulario__register">
                    <h2>Add Truck</h2>
                    <br>
                   
                    <input type="text" name="matricula"  placeholder="matricula"  required>
                    <p>DEPARTURE</p><input type="date" name="partida" placeholder="partida"    required>
                    <p>ARRIVAL</p> <input type="date" name="llegada" placeholder="llegada"    required>
                    <input type="text" name="destino_camion" placeholder="destino_camion"   required>
                    <input type="text" name="entregada" placeholder="entrega"  required>
                    <input type="text" name="estado" placeholder="estado"   required>
                    <input type="text" name="idCamionero" placeholder="idCamionero"   required>
                    <br>
                    <button>Add</button>
                </form>
                </div>
			...
			$(function(){
			   ...
			   $(this).toggleClass('active');          
                ...
                <div id="adm">
                <form action="../BackEnd/eliminarCamion_be.php" method="POST" class="formulario__register">
                    <h2>Delete Truck</h2>
                    <br>
                    <input type="text" name="matricula"  placeholder="matricula"  required>
                    <br>
			...
			$(function(){
			   ...
			   $(this).toggleClass('active');          
                ...
                <div id="adm">
                <form action="../BackEnd/modificarCamion_be.php" method="POST" class="formulario__register">
                    <h2>Modify Truck</h2>
                    <br>
                    <h3>Car registration of the truck to modify</h3>
                    <input type="text" name="matricula"  placeholder="matricula"  required>
                    <br><br>
                    <h3>modify it</h3>
                    <p>DEPARTURE</p><input type="date" name="partida"  placeholder="partida"  required>
