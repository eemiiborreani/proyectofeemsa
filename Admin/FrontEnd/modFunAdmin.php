...
<body>
   <div class="container">
    ...
    <a id="paq" class="fa fa-plus-square"></a>
                <div id="adm">
                <form action="../BackEnd/registerFun_be.php" method="POST" class="formulario__register">
			...
			$(function(){
			   ...
			   $(this).toggleClass('active');          
                ...
                <div id="adm">
                <form action="../BackEnd/eliminarFun_be.php" method="POST" class="formulario__register">
			...
			$(function(){
			   ...
			   $(this).toggleClass('active');          
                ...
                <div id="adm">
                <form action="../BackEnd/modificarFun_be.php" method="POST" class="formulario__register">
                    <h2>Modificar Funcionario</h2>
                    <br>
                    <h3>id del funcionario a modificar</h3>
                    <input type="number" name="id"  placeholder="id"  required>
                    <br><br>
