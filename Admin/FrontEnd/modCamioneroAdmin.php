...
<body>
   <div class="container">
    ...
    <a id="paq" class="fa fa-plus-square"></a>
                <div id="adm">
                <form action="../BackEnd/registerCamionero_be.php" method="POST" class="formulario__register">
                    <h2>Ingresar Camionero</h2>
                    <br>
                   
                    <input type="text" name="username"  placeholder="Nombre de Usuario"  required>
                    <input type="text" name="matriculaCamion" placeholder="Matricula"    required>
			...
			$(function(){
			   ...
			   $(this).toggleClass('active');          
                ...
                <div id="adm">
                <form action="../BackEnd/eliminarCamionero_be.php" method="POST" class="formulario__register">
                    <h2>Eliminar Camionero</h2>
                    <br>
			...
			$(function(){
			   ...
			   $(this).toggleClass('active');          
                ...
                <div id="adm">
                <form action="../BackEnd/modificarCamionero_be.php" method="POST" class="formulario__register">
                    <h2>Modificar Camionero</h2>
                    <br>
                    <h3>id del Camionero a modificar</h3>
                    <input type="number" name="id"  placeholder="id"  required>
                    <br><br>
		...
		<tr>
			...
			<td><?php echo $mostrar['matriculaAsignada'] ?></td>
