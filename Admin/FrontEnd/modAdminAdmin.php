...
<body>
   <div class="container">
    ...
    <a id="paq" class="fa fa-plus-square"></a>
                <div id="adm">
                <form action="../BackEnd/registerAdmin2_be.php" method="POST" class="formulario__register">
                    <h2>Ingresar Admin</h2>
                    <br>
			...
			$(function(){
			   ...
			   $(this).toggleClass('active');          
                ...
                <div id="adm">
                <form action="../BackEnd/eliminarAdmin_be.php" method="POST" class="formulario__register">
			...
			$(function(){
			   ...
			   $(this).toggleClass('active');          
                ...
                <div id="adm">
                <form action="../BackEnd/modificarAdmin_be.php" method="POST" class="formulario__register">
                    <h2>Modificar Admin</h2>
                    <br>
                    <h3>id del admin a modificar</h3>
                    <input type="number" name="id"  placeholder="id"  required>
                    <br><br>
