...
<body>
   <div class="container">
    <div class="navbar">
      ...
      <nav>
        <ul>
        <li><a id="home" href="../../User/indexEn.php" class="fa fa-home"></a></li>
        
        <li><a id="user" href="../../User/usuarioEN.php" class="fa fa-user"></a></li>
    ...
    <main>
        ...
        <div class="contenedor__todo">
            ...
            <div class="contenedor__login-register">
                ...
                <form action="../BackEnd/loginCliente_be.php" method="POST"  class="formulario__login">
                    <h2>Log In</h2>
                ...
                <form action="../BackEnd/registerCliente_be.php" method="POST" class="formulario__register">
                    <h2>Register</h2>
