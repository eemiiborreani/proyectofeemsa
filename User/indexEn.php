...
<body>
   <div class="container">
    <div class="navbar">
      ...
      <nav>
        <ul>
        <li><a id="home" href="indexEn.php" class="fa fa-home"></a></li>
        
        <li><a id="user" href="usuarioEN.php" class="fa fa-user"></a></li>
        
        <li><a id="menu-icon" href="../index.php" class="fa fa-language"></a></li>
      </ul>
      </nav>
    ...
    <div class="row">
      <div class="col">
        <h1>GoNow</h1>
        <p id="texto1">Ask fast, Receive fast</p>
        <a href="#ancla-1"><button type="button">Us</button></a>
      </div>
      <div class="col">
      <div class="camion">
      </div>
