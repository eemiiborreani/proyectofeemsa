...
<body>
   ...
   <a href="../Cliente/FrontEnd/loginRegisterClienteIndex.php"><button id="boton1" type="button">Iniciar sesion / Registrarse</button></a>
    </div>
</div>
...
<a href="../Camionero/FrontEnd/loginRegisterCamioneroIndex.php"><button id="boton1" type="button">Iniciar sesion / Registrarse</button></a>
</div>
</div>
...
<div class="funcionario">
   ...
   <a href="../Funcionario/FrontEnd/loginRegisterFuncionarioIndex.php"><button id="boton1" type="button">Iniciar sesion / Registrarse</button></a>
    </div>
</div>
...
<div id="usuario">
    ...
    <a href="../Admin/FrontEnd/loginRegisterAdministradorIndex.php"><button id="boton1" type="button">Iniciar sesion / Registrarse</button></a>
</div>
</div>
</div>
